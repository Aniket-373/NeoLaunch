...
const Footer = () => {
  return (
    <div className='footer bg-[#111111] pt-5 pd-10'>
  ...
  <span className="block text-sm text-center text-white">
    ...
    <a  href="https://react.dev/" className="text-green-600 hover:underline pl-1">
         React
    </a>{" "}
    and 
    <a
      href="https://tailwindcss.com"
      className="text-green-600 hover:underline pl-1"
    >
        Tailwind CSS
    </a>
    .
